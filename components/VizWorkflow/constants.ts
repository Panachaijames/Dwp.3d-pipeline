...
export const TOOLS: VizTool[] = [
    ...
    { id: "dwppitch", name: "dwp.design pitching", url: "https://dwp-design-hub-747963782073.asia-southeast1.run.app/pitching", phase: ["CON"], abbr: "DP", icon: "◈", desc: "Full pitch deck with visuals — AI-generated presentations", internal: true, order: 2 },
