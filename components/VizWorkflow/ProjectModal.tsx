        ...
        <div className="vw-ov" onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
            <div className="vw-mdl">
                ...
                <div className="vw-mdl-a">
                    {isEdit && onDelete && <button className="vw-btn vw-btn-d vw-btn-sm" style={{ marginRight: "auto" }} onClick={() => { if (confirm('Are you sure you want to delete this project? All prompt logs and PDF data will be permanently deleted.')) onDelete(p.id); }}>Delete Project</button>}
