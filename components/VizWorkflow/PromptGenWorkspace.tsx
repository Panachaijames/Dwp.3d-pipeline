...
const LLM_PROVIDERS = [
    ...
    { id: "gpt4", label: "GPT-4o", active: false },
];
...
export default function PromptGenWorkspace({ proj, logs, saveL, freshLog: makeFresh }: Props) {
    ...
    const generate = async () => {
        ...
        setLoading(true);
        const endpoint = llmProvider === "claude" ? "/api/claude" : "/api/gemini";
    ...
    const handleRetry = async (r: PGResult) => {
        ...
        const endpoint = r.llm === "claude" ? "/api/claude" : "/api/gemini";
                        ...
                        <div key={r.id} className="vw-pg-result">
                            <div className="vw-pg-result-hd">
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                                    <span style={{ fontSize: 8, color: "var(--tx3)", textTransform: "uppercase", letterSpacing: 1 }}>{r.llm === "claude" ? "Claude Opus" : r.llm === "gemini" ? "Gemini 3.1 Pro" : r.llm}</span>
