...
import { PHASES, TOOLS, VizProject, VizLog, VizTool, PhaseKey, phaseOf, phaseIdx, freshProject } from './constants';
    ...
    if (!proj) return (
        <div className="vw-pnl">
            <div className="vw-empty" style={{ paddingTop: 80 }}>
                <div className="ei">◫</div><div className="et">Create or select a project</div>
                <div className="es">Your workspace shows phase-relevant tools, sessions, and prompt logging.</div>
                <button className="vw-btn vw-btn-p" onClick={() => setEditProj(freshProject())}>New Project</button>
            </div>
        </div>
    );
