        ...
        <div className={`vw-root ${dark ? 'viz-dark' : 'viz-light'}`}>
            ...
            <div className={`vw-rail ${rail ? 'open' : 'closed'}`}>
                ...
                <div className="vw-rail-body">
                    ...
                    <div className="vw-ri" onClick={() => window.location.assign('/boards')} title="Material boards, board canvas, object extractor & image tagging — opens the Boards studio">
                        <span className="vw-ic">▦</span><span>Boards Studio ↗</span>
                    </div>
                </div>
            </div>
